...
public class AppRuntimeException extends RuntimeException {
    ...
    /**
     * 用来反应业务异常信息的错误信息，�?��会结合配置来说明<code>errorCode</code>
     */
    private String errorMessage;

    /**
     * 异常信息描述，用来描�?code>cause</code>
     */
    ...
    public AppRuntimeException(ResultInfoEnum msg) {
        this(msg.getErrorCode(), msg.getErrorMsg());
    }

    public AppRuntimeException(ResultInfoEnum msg, String extMessage) {
        this(msg.getErrorCode(), msg.getErrorMsg(extMessage));
    }
